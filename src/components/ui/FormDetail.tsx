...
interface FormDetailProps<T extends FieldValues> {
    schema: z.ZodType<T>;
    fields: UIFieldMeta[];
    data: T;
...
export function FormDetail<T extends FieldValues>({
    schema,
    fields,
    data,
    onSubmit,
    ...
    const {
        ...
        defaultValues: data as import("react-hook-form").DefaultValues<T>,
    });
    ...
    const execSubmit: SubmitHandler<T> = async (formData) => {
