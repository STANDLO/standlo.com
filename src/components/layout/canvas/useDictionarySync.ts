...
import canvasMaterialsFallback from "@/core/constants/canvas_materials.json";
import canvasTexturesFallback from "@/core/constants/canvas_textures.json";
...
export function useDictionarySync() {
  const setDictionaries = useCanvasStore((state) => state.setDictionaries);
