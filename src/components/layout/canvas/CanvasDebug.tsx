...
import { runInstancingStressTest } from "@/scripts/canvas-ai-stress-test";
    ...
    return (
        <Popover open={isOpen} onOpenChange={setIsOpen}>
            <PopoverTrigger asChild>
                <button
                    className="ui-canvas-tools-btn h-10 w-10 flex items-center justify-center p-0 hover:bg-zinc-100 dark:hover:bg-zinc-800 transition-colors"
                    data-active={isOpen}
