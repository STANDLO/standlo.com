...
export function CanvasAI() {
    ...
    const selectedEntity = selectedEntityId ? useCanvasStore.getState().entities[selectedEntityId] : null;
    ...
    const handlePromptSubmit = async (e: React.FormEvent) => {
        ...
        if (promptText.includes("#move") && selectedEntityId && selectedEntity) {
            ...
            CanvasController.moveEntity(selectedEntityId, newPos);
