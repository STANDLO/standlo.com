...
export function DesignCatalogSidebar({ entityId, entityType }: { entityId?: string, entityType?: string | null }) {
        ...
        const fetchItems = async () => {
            try {
                ...
                try {
                    ...
                    console.warn(`[DesignCatalogSidebar] Fetch failed, falling back to mock...`, err);
                    if (isMounted) {
                        setItems([
