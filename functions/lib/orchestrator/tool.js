...
exports.createToolEntity = createToolEntity;
exports.updateToolEntity = updateToolEntity;
exports.deleteToolEntity = deleteToolEntity;
const firestore_1 = require("firebase-admin/firestore");
const app_1 = require("firebase-admin/app");
const firestore = (0, firestore_1.getFirestore)((0, app_1.getApp)(), "standlo");
const crypto_1 = require("crypto");
async function createToolEntity(uid, payload) {
    const toolId = payload.id || (0, crypto_1.randomUUID)();
    const now = new Date().toISOString();
    const toolData = Object.assign(Object.assign({ id: toolId, orgId: payload.orgId || null, ownId: uid }, payload), { createdAt: now, createdBy: uid, updatedAt: now, updatedBy: uid, deletedAt: null, isArchived: false });
...
async function updateToolEntity(uid, toolId, payload) {
    const now = new Date().toISOString();
...
async function deleteToolEntity(uid, toolId) {
