...
exports.BuildPolicyMatrix = exports.BuildSearchSchema = exports.BuildUpdateSchema = exports.BuildCreateSchema = exports.BuildToolNodeSchema = exports.BuildProcessNodeSchema = exports.BuildPartNodeSchema = exports.BuildAssemblyNodeSchema = exports.BuildCanvasNodeSchema = exports.BuildSchema = void 0;
const zod_1 = require("zod");
const base_1 = require("./base");
exports.BuildSchema = base_1.BaseSchema.extend({
    name: zod_1.z.string().describe("Name or identifier of the modular construction project"),
    description: zod_1.z.string().optional(),
    location: zod_1.z.string().optional(),
});
// --- SUBCOLLECTION SCHEMAS ---
exports.BuildCanvasNodeSchema = zod_1.z.object({
...
exports.BuildAssemblyNodeSchema = zod_1.z.object({
    assemblyId: zod_1.z.string(),
    quantity: zod_1.z.number()
});
exports.BuildPartNodeSchema = zod_1.z.object({
    partId: zod_1.z.string(),
    quantity: zod_1.z.number()
});
exports.BuildProcessNodeSchema = zod_1.z.object({
    processId: zod_1.z.string(),
    quantity: zod_1.z.number()
});
exports.BuildToolNodeSchema = zod_1.z.object({
    toolId: zod_1.z.string(),
    quantity: zod_1.z.number()
});
exports.BuildCreateSchema = (0, base_1.createCreationSchema)(exports.BuildSchema);
exports.BuildUpdateSchema = (0, base_1.createUpdateSchema)(exports.BuildSchema);
exports.BuildSearchSchema = base_1.PaginationQuerySchema.extend({
    name: zod_1.z.string().optional(),
});
exports.BuildPolicyMatrix = {
