...
exports.CalendarPolicyMatrix = exports.CalendarSearchSchema = exports.CalendarUpdateSchema = exports.CalendarCreateSchema = exports.CalendarSchema = void 0;
const zod_1 = require("zod");
const base_1 = require("./base");
exports.CalendarSchema = base_1.BaseSchema.extend({});
exports.CalendarCreateSchema = (0, base_1.createCreationSchema)(exports.CalendarSchema);
exports.CalendarUpdateSchema = (0, base_1.createUpdateSchema)(exports.CalendarSchema);
exports.CalendarSearchSchema = base_1.PaginationQuerySchema.extend({
    name: zod_1.z.string().optional()
});
exports.CalendarPolicyMatrix = {
