...
exports.MessagePolicyMatrix = exports.MessageSearchSchema = exports.MessageUpdateSchema = exports.MessageCreateSchema = exports.MessageSchema = void 0;
const zod_1 = require("zod");
const base_1 = require("./base");
exports.MessageSchema = base_1.BaseSchema.extend({});
exports.MessageCreateSchema = (0, base_1.createCreationSchema)(exports.MessageSchema);
exports.MessageUpdateSchema = (0, base_1.createUpdateSchema)(exports.MessageSchema);
exports.MessageSearchSchema = base_1.PaginationQuerySchema.extend({
    name: zod_1.z.string().optional()
});
exports.MessagePolicyMatrix = {
