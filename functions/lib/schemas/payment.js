...
exports.PaymentPolicyMatrix = exports.PaymentSearchSchema = exports.PaymentUpdateSchema = exports.PaymentCreateSchema = exports.PaymentSchema = void 0;
const zod_1 = require("zod");
const base_1 = require("./base");
exports.PaymentSchema = base_1.BaseSchema.extend({});
exports.PaymentCreateSchema = (0, base_1.createCreationSchema)(exports.PaymentSchema);
exports.PaymentUpdateSchema = (0, base_1.createUpdateSchema)(exports.PaymentSchema);
exports.PaymentSearchSchema = base_1.PaginationQuerySchema.extend({
    name: zod_1.z.string().optional()
});
exports.PaymentPolicyMatrix = {
