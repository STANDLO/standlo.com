...
exports.RentPolicyMatrix = exports.RentSearchSchema = exports.RentUpdateSchema = exports.RentCreateSchema = exports.RentSchema = void 0;
const zod_1 = require("zod");
const base_1 = require("./base");
exports.RentSchema = base_1.BaseSchema.extend({
    name: zod_1.z.string(), // e.g. "Noleggio Pannelli"
    productId: zod_1.z.string(),
    quantity: zod_1.z.number().min(1),
    startDate: zod_1.z.string().datetime(),
    endDate: zod_1.z.string().datetime(),
    status: zod_1.z.enum(['active', 'returned', 'pending']).default('pending')
});
exports.RentCreateSchema = (0, base_1.createCreationSchema)(exports.RentSchema);
exports.RentUpdateSchema = (0, base_1.createUpdateSchema)(exports.RentSchema);
exports.RentSearchSchema = base_1.PaginationQuerySchema.extend({
    name: zod_1.z.string().optional(),
    productId: zod_1.z.string().optional(),
    status: zod_1.z.enum(['active', 'returned', 'pending']).optional()
});
exports.RentPolicyMatrix = {
