...
exports.InvoicePolicyMatrix = exports.InvoiceSearchSchema = exports.InvoiceUpdateSchema = exports.InvoiceCreateSchema = exports.InvoiceSchema = void 0;
const zod_1 = require("zod");
const base_1 = require("./base");
exports.InvoiceSchema = base_1.BaseSchema.extend({});
exports.InvoiceCreateSchema = (0, base_1.createCreationSchema)(exports.InvoiceSchema);
exports.InvoiceUpdateSchema = (0, base_1.createUpdateSchema)(exports.InvoiceSchema);
exports.InvoiceSearchSchema = base_1.PaginationQuerySchema.extend({
    name: zod_1.z.string().optional()
});
exports.InvoicePolicyMatrix = {
