...
export const MessageCreateSchema = createCreationSchema(MessageSchema);
export const MessageUpdateSchema = createUpdateSchema(MessageSchema);
export const MessageSearchSchema = PaginationQuerySchema.extend({
    name: z.string().optional()
});

export const MessagePolicyMatrix: Record<RoleId, EntityPolicy> = {
