...
export const PaymentCreateSchema = createCreationSchema(PaymentSchema);
export const PaymentUpdateSchema = createUpdateSchema(PaymentSchema);
export const PaymentSearchSchema = PaginationQuerySchema.extend({
    name: z.string().optional()
});
export const PaymentPolicyMatrix: Record<RoleId, EntityPolicy> = {
    guest: {
        canCreate: false,
        canRead: false,
        canUpdate: false,
