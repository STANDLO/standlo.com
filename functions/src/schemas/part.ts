...
export const PartPolicyMatrix: Record<RoleId, EntityPolicy> = {
    guest: { canCreate: false, canRead: true, canUpdate: false, canDelete: false, fieldPermissions: { id: { read: true, write: false }, orgId: { read: true, write: false }, name: { read: true, write: false }, code: { read: true, write: false }, ownId: { read: true, write: false }, active: { read: true, write: false }, version: { read: true, write: false }, users: { read: true, write: false }, updates: { read: true, write: false }, meta: { read: true, write: false }, createdAt: { read: true, write: false }, createdBy: { read: true, write: false }, updatedAt: { read: true, write: false }, updatedBy: { read: true, write: false }, deletedAt: { read: true, write: false }, deletedBy: { read: true, write: false }, isArchived: { read: true, write: false }, endLifeTime: { read: true, write: false }, dimension: { read: true, write: false }, position: { read: true, write: false }, rotation: { read: true, write: false }, description: { read: true, write: false }, sector: { read: true, write: false }, category: { read: true, write: false }, isRentable: { read: true, write: false }, isSellable: { read: true, write: false }, isConsumable: { read: true, write: false }, baseUnit: { read: true, write: false }, cost: { read: true, write: false }, price: { read: true, write: false }, meshId: { read: true, write: false }, defaultTextureId: { read: true, write: false }, gltfUrl: { read: true, write: false }, useCases: { read: true, write: false }, sockets: { read: true, write: false } } },
    ...
    standlo_manager: { canCreate: true, canRead: true, canUpdate: true, canDelete: true, fieldPermissions: { id: { read: true, write: true }, orgId: { read: true, write: true }, name: { read: true, write: true }, code: { read: true, write: true }, ownId: { read: true, write: true }, active: { read: true, write: true }, version: { read: true, write: true }, users: { read: true, write: true }, updates: { read: true, write: true }, meta: { read: true, write: true }, createdAt: { read: true, write: true }, createdBy: { read: true, write: true }, updatedAt: { read: true, write: true }, updatedBy: { read: true, write: true }, deletedAt: { read: true, write: true }, deletedBy: { read: true, write: true }, isArchived: { read: true, write: true }, endLifeTime: { read: true, write: true }, dimension: { read: true, write: true }, position: { read: true, write: true }, rotation: { read: true, write: true }, description: { read: true, write: true }, sector: { read: true, write: true }, category: { read: true, write: true }, isRentable: { read: true, write: true }, isSellable: { read: true, write: true }, isConsumable: { read: true, write: true }, baseUnit: { read: true, write: true }, cost: { read: true, write: true }, price: { read: true, write: true }, meshId: { read: true, write: true }, defaultTextureId: { read: true, write: true }, gltfUrl: { read: true, write: true }, useCases: { read: true, write: true }, sockets: { read: true, write: true } } },
