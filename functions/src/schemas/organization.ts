...
export const OrganizationSchema = z.object({
    ...
    roleId: RoleIdSchema.describe(JSON.stringify({ type: "select", required: true, label: "Ruolo aziendale", options: RoleOptions })),
    ...
    vatNumber: z.string().optional().describe(JSON.stringify({ type: "text", required: true, label: "Partita IVA / Codice Fiscale" })),
    ...
    fullAddress: z.string().optional().describe(JSON.stringify({ type: "place", required: true, label: "Indirizzo Sede Operativa" })),
