...
export const NotificationCreateSchema = createCreationSchema(NotificationSchema);
export const NotificationUpdateSchema = createUpdateSchema(NotificationSchema);
export const NotificationSearchSchema = PaginationQuerySchema.extend({
    name: z.string().optional()
});
export const NotificationPolicyMatrix: Record<RoleId, EntityPolicy> = {
