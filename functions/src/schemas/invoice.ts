...
export const InvoiceCreateSchema = createCreationSchema(InvoiceSchema);
export const InvoiceUpdateSchema = createUpdateSchema(InvoiceSchema);
export const InvoiceSearchSchema = PaginationQuerySchema.extend({
    name: z.string().optional()
});
export const InvoicePolicyMatrix: Record<RoleId, EntityPolicy> = {
