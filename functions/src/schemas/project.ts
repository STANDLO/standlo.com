...
export const ProjectCreateSchema = createCreationSchema(ProjectSchema);
export const ProjectUpdateSchema = createUpdateSchema(ProjectSchema);
export const ProjectSearchSchema = PaginationQuerySchema.extend({
    name: z.string().optional()
});

export const ProjectPolicyMatrix: Record<RoleId, EntityPolicy> = {
